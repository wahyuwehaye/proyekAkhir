...
$route['404_override'] = '';
$route['translate_uri_dashes'] = FALSE;
$route['fasilities'] = 'main/fasilities';
$route['rooms'] = 'main/rooms';
$route['contact'] = 'main/contact';
$route['soon'] = 'main/soon';
...
$route['databooking'] = 'dashboard/databooking';
$route['datacheckin'] = 'dashboard/datacheckin';
$route['datacheckout'] = 'dashboard/datacheckout';
$route['formcheckout'] = 'dashboard/formcheckout';
$route['onsite'] = 'dashboard/onsite';
$route['lapharian'] = 'dashboard/lapharian';
$route['lapbulanan'] = 'dashboard/lapbulanan';
$route['buktibayar'] = 'dashboard/buktibayar';
$route['sendsms'] = 'dashboard/sendsms';
$route['daftarsms'] = 'dashboard/daftarsms';
$route['promosi'] = 'dashboard/promosi';
$route['laporharian'] = 'dashboard/laporharian';
$route['laporbulanan'] = 'dashboard/laporbulanan';
