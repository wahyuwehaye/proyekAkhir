...
class M_sms extends CI_Model {
	...
	var $table = 'sentitems';
	var $table1 = 'outbox';
	var $column_order = array('DestinationNumber','TextDecoded','CreatorID',null); //set column field database for datatable orderable
	var $column_search = array('DestinationNumber','TextDecoded','CreatorID'); //set column field database for datatable searchable just firstname , lastname , address are searchable
