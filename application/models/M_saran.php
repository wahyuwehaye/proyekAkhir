...
class M_saran extends CI_Model {
	...
	var $table = 'kritiksaran';
	var $column_order = array('nama','email','message',null); //set column field database for datatable orderable
	var $column_search = array('nama','email','message'); //set column field database for datatable searchable just firstname , lastname , address are searchable
