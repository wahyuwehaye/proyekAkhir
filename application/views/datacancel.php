  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="active"><a href="<?php echo base_url()?>index.php/dashboard/datacancel"><i class="fa fa-list-ol"></i> <span> Data Canceled</span></a></li>
...
$(document).ready(function() {
    ...
    table = $('#table').DataTable({
        ...
        "ajax": {
            "url": "<?php echo site_url('Mastercancel/ajax_list')?>",
            "type": "POST"
        },
...
function edit_cancel(id)
{
    ...
    $.ajax({
        url : "<?php echo site_url('Mastercancel/ajax_edit/')?>/" + id,
        type: "GET",
        dataType: "JSON",
...
function detail_cancel(id)
{
    ...
    //Ajax Load data from ajax
    $.ajax({
        url : "<?php echo site_url('Mastercancel/ajax_detail/')?>/" + id,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {
...
function save()
{
    ...
    if(save_method == 'add') {
        url = "<?php echo site_url('Mastercancel/ajax_add')?>";
    } else {
        url = "<?php echo site_url('Mastercancel/ajax_update')?>";
    }
...
function delete_cancel(id)
{
    if(confirm('Are you sure delete this data?'))
    {
        ...
        $.ajax({
            url : "<?php echo site_url('Mastercancel/ajax_delete')?>/"+id,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
