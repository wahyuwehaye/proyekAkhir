  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="active"><a href="<?php echo base_url()?>index.php/dashboard/datacheckin"><i class="fa fa-list-alt"></i> <span> Data Check In</span></a></li>
        <li class="treeview">
          <a href="#">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Data Check In Kamar</li>
      </ol>
    </section>
    ...
    <section class="content">
          ...
          <div class="box">
              ...
              <button class="btn btn-xs btn-success" onclick="add_checkin()"><i class="glyphicon glyphicon-plus"></i></button>
...
$(document).ready(function() {
    ...
    table = $('#table').DataTable({
        ...
        "ajax": {
            "url": "<?php echo site_url('Mastercheckin/ajax_list')?>",
            "type": "POST"
        },
...
function add_checkin()
{
    ...
    $('.modal-title').text('Tambah checkin'); // Set Title to Bootstrap modal title
}
...
function edit_checkin(id)
{
    ...
    $.ajax({
        url : "<?php echo site_url('Mastercheckin/ajax_edit/')?>/" + id,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {
            ...
            $('.modal-title').text('Edit checkin'); // Set title to Bootstrap modal title
...
function detail_checkin(id)
{
    ...
    //Ajax Load data from ajax
    $.ajax({
        url : "<?php echo site_url('Mastercheckin/ajax_detail/')?>/" + id,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {
            ...
            $('.modal-title').text('Detail checkin'); // Set title to Bootstrap modal title
...
function save()
{
    ...
    if(save_method == 'add') {
        url = "<?php echo site_url('Mastercheckin/ajax_add')?>";
    } else {
        url = "<?php echo site_url('Mastercheckin/ajax_update')?>";
    }
...
function delete_checkin(id)
{
    if(confirm('Are you sure delete this data?'))
    {
        ...
        $.ajax({
            url : "<?php echo site_url('Mastercheckin/ajax_delete')?>/"+id,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
