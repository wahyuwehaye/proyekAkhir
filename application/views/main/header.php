...
<div class="top-header">
	<div class="container">
		<div class="top-header-main">
			<div class="navbar-header">
			              ...
			              <div class="logo wow slideInLeft" data-wow-delay="0.3s">
			                    <a class="navbar-brand" href="<?php echo base_url()?>"><img src="<?php echo base_url()?>assets/images/Ch2.png" width="150" height="60" /></a>
			              </div>
			          </div>
		<nav class="main-nav" id="cl-effect-16">
        ...
        <li><a class="cd-signup" href="<?php echo base_url()?>index.php/rooms" data-hover="Rooms">Rooms</a></li>
				...
				{ ?>
					<li><a class="cd-signup" href="<?php echo base_url()?>index.php/dashboard/logOut" data-hover="LOGOUT">LOGOUT</a></li>

				<?php }else{ ?>
				<li><a class="cd-signup" href="<?php echo base_url()?>index.php/login" data-hover="REGISTER">REGISTER</a></li>
				<?php } ?>
			</ul>
		</nav>
	</div>
